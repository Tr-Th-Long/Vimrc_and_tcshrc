...
let s:colors = {
      ...
      \ "light_blue": get(s:overrides, "dark_purple", { "gui": "#939ede", "cterm": "81", "cterm16": "4"}),
      \ "purple": get(s:overrides, "purple", { "gui": "#c792ea", "cterm": "170", "cterm16": "5" }),
      \ "light_purple": get(s:overrides, "light_purple", { "gui": "#c792ea", "cterm": "5", "cterm16": "5" }),
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#697098", "cterm": "247", "cterm16": "15" }),
      ...
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#3B4048", "cterm": "241", "cterm16": "15" }),
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#181A1F", "cterm": "33", "cterm16": "15" }),
      ...
      \ "white_mask_4": get(s:overrides, "white_mask_4", { "gui": "#474b59", "cterm": "253", "cterm16": "15" }),
