...
let s:colors = {
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#8389AA", "cterm": "59", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#6E7891", "cterm": "238", "cterm16": "15" }),
      \ "gutter_fg_grey2": get(s:overrides, "gutter_fg_grey2", { "gui": "#F0F1F4", "cterm": "238", "cterm16": "15" }),
      ...
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#F1F2F4", "cterm": "238", "cterm16": "15" }),
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#F1F2F4", "cterm": "59", "cterm16": "15" }),
